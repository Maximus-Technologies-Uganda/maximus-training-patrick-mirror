...
describe('Expense Tracker Frontend', () => {
  ...
  describe('filterExpenses', () => {
    ...
    const noResultScenarios = [
      ...
      ['empty expenses with month filter only', [], '2025-01', ''],
      ['empty expenses with category filter only', [], '', 'groceries'],
      [
  ...
  describe('calculateTotal', () => {
    it('should calculate total of valid amounts', () => {
      const expenses = [{ amount: 10 }, { amount: 15.5 }, { amount: 7.25 }];
    ...
    it('should handle expenses without amount property', () => {
      const expenses = [{ category: 'groceries' }, { amount: 10 }];
