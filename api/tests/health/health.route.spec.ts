...
describe('GET /health', () => {
  ...
  it('reports firebase dependency down when project id is missing in production', async () => {
    ...
    try {
      ...
      delete process.env.FIREBASE_AUTH_PROJECT_ID;
      ...
      expect(res.status).toBe(503);
      expect(res.body.dependencies.firebase).toBe('down');
      expect(res.body.dependencies.details.firebase).toContain('project id missing');
    } finally {
