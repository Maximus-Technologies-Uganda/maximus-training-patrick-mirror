...
Welcome to the Training monorepo. This guide explains the repository layout, branching/review process, and the complete local validation workflow aligned to Week 6 Finishers. It references the feature artifacts:
...
- `specs/005-week-6-finishers/`: Spec, plan, and tasks for Week 6 Finishers.
...
2) Type-check gate (Week 6 FR-016)
...
- `specs/005-week-6-finishers/spec.md`
- `specs/005-week-6-finishers/plan.md`
